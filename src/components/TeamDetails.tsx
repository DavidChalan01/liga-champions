      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-card-hover">
        <CardHeader className="bg-gradient-sport text-primary-foreground">
          <div className="flex items-center justify-between">
            <CardTitle className="text-2xl font-bold">{team.teamName}</CardTitle>
            <button onClick={onClose} className="text-primary-foreground hover:text-primary-foreground/80 transition-colors">
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <h3 className="font-semibold text-foreground">Estadísticas del Torneo</h3>
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between p-2 bg-secondary/30 rounded">
                  ...
                  <span className="font-semibold text-foreground">{team.lost}</span>
                </div>
              </div>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold text-foreground">Disciplina</h3>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between p-2 bg-secondary/30 rounded">
                  <span className="text-muted-foreground">T. Amarillas:</span>
                  <span className="font-semibold text-yellow-600">{team.yellowCards}</span>
                </div>
                <div className="flex justify-between p-2 bg-secondary/30 rounded">
                  <span className="text-muted-foreground">T. Rojas:</span>
                  <span className="font-semibold text-red-600">{team.redCards}</span>
                </div>
                <div className="flex justify-between p-2 bg-secondary/30 rounded">
